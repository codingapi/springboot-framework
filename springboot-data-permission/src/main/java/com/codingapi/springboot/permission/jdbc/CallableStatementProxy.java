...
//todo now not support CallableStatementProxy
@Slf4j
public class CallableStatementProxy extends PreparedStatementProxy implements CallableStatement {
    ...
    public CallableStatementProxy(CallableStatement delegate, SQL sql) throws SQLException {
        super(delegate, sql);
        this.delegate = delegate;
        this.jdbcSql = new JdbcSql(sql);
        log.warn("now not support proxy .");
    }
