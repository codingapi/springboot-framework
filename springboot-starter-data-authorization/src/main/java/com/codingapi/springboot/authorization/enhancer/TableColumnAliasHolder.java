        ...
        if (selectItems != null) {
            for (SelectItem<?> selectItem : selectItems) {
                ...
                if (expression instanceof AllTableColumns) {
                    ...
                    projection.addStarTable(this.starTableOf(((AllTableColumns) expression).getTable()));
                    ...
                    this.putProjectionColumn(projection, subPlainSelect, (Column) expression, aliasName);
