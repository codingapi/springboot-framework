...
public class CallableStatementProxy implements CallableStatement {
    ...
    public ResultSet executeQuery() throws SQLException {
        return new ResultSetProxy(callableStatement.executeQuery());
    }
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        return new ResultSetProxy(callableStatement.executeQuery(SQLRunningContext.getInstance().intercept(sql)));
    }

    @Override
    public int executeUpdate(String sql) throws SQLException {
        return callableStatement.executeUpdate(SQLRunningContext.getInstance().intercept(sql));
    }
    ...
    public boolean execute(String sql) throws SQLException {
        return callableStatement.execute(SQLRunningContext.getInstance().intercept(sql));
    }

    @Override
    public ResultSet getResultSet() throws SQLException {
        return new ResultSetProxy(callableStatement.getResultSet());
    }
    ...
    public void addBatch(String sql) throws SQLException {
        callableStatement.addBatch(SQLRunningContext.getInstance().intercept(sql));
    }
    ...
    public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        return callableStatement.executeUpdate(SQLRunningContext.getInstance().intercept(sql), autoGeneratedKeys);
    }

    @Override
    public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
        return callableStatement.executeUpdate(SQLRunningContext.getInstance().intercept(sql), columnIndexes);
    }

    @Override
    public int executeUpdate(String sql, String[] columnNames) throws SQLException {
        return callableStatement.executeUpdate(SQLRunningContext.getInstance().intercept(sql), columnNames);
    }

    @Override
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        return callableStatement.execute(SQLRunningContext.getInstance().intercept(sql), autoGeneratedKeys);
    }

    @Override
    public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        return callableStatement.execute(SQLRunningContext.getInstance().intercept(sql), columnIndexes);
    }

    @Override
    public boolean execute(String sql, String[] columnNames) throws SQLException {
        return callableStatement.execute(SQLRunningContext.getInstance().intercept(sql), columnNames);
    }
    ...
    public long executeLargeUpdate(String sql) throws SQLException {
        return callableStatement.executeLargeUpdate(SQLRunningContext.getInstance().intercept(sql));
    }

    @Override
    public long executeLargeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        return callableStatement.executeLargeUpdate(SQLRunningContext.getInstance().intercept(sql), autoGeneratedKeys);
    }

    @Override
    public long executeLargeUpdate(String sql, int[] columnIndexes) throws SQLException {
        return callableStatement.executeLargeUpdate(SQLRunningContext.getInstance().intercept(sql), columnIndexes);
    }

    @Override
    public long executeLargeUpdate(String sql, String[] columnNames) throws SQLException {
        return callableStatement.executeLargeUpdate(SQLRunningContext.getInstance().intercept(sql), columnNames);
    }
